                ...
                <div class="col-md-9">
                    <ul class="booking-list">
                        <?php
                            ...
                            $args=array('paged'=>$paged, 'post_type'=>'complejo');
                            query_posts($args);
                        ?>
                        <?php query_posts('post_type=complejo'); ?>
                            ...
                            <a class="booking-item" href="<?php the_permalink(); ?>">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <?php 
                                            echo hotel_campo( 'img-hotel-direccion' ); 
                                            echo restaurante_campo( 'img-restaurantes-direccion' ); 
                                            echo zoologico_campo( 'img-zoologico-direccion' );
                                            echo complejo_campo( 'img-complejo-direccion' );
                                            echo piscina_campo( 'img-piscina-direccion' );
                                            echo bar_campo( 'img-bar-direccion' );
                                        ?>
                                        </p>
                                        <?php the_excerpt(); ?>
                                    </div>
