                ...
                <header class="booking-item-header">
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <p class="lh1em text-small"><i class="fa fa-map-marker"></i> <?php echo zoologico_campo( 'img-zoologico-direccion' ); ?></p>
                            <ul class="list list-inline text-small">
                                <li><a href="#"><i class="fa fa-envelope"></i> E-mail del anunciante</a>
                                </li>
                                <li><a href="<?php echo zoologico_campo( 'img-zoologico-sitio' ); ?>"><i class="fa fa-home"></i> Sitio web del anunciante</a>
                                </li>
                                <li><i class="fa fa-phone"></i> <?php echo zoologico_campo( 'img-zoologico-telefono' ); ?></li>
                            </ul> 
                        </div>
                        <div class="col-md-3">
                ...
                <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-1">
                                    <div class="fotorama" data-allowfullscreen="true" data-nav="thumbs">
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-uno' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF library" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-dos' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY LIBERDADE" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-tres' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-cuatro' ); ?>" alt="Image Alternative text" title="hotel EDEN MAR suite" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-cinco' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF living room" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-seis' ); ?>" alt="Image Alternative text" title="hotel 2" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-siete' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL rooftop pool" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-ocho' ); ?>" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO lobby" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-nueve' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY SERRA GOLF suite2" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-diez' ); ?>" alt="Image Alternative text" title="hotel THE CLIFF BAY spa suite" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-once' ); ?>" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO luxury suite" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-doce' ); ?>" alt="Image Alternative text" title="LHOTEL PORTO BAY SAO PAULO suite lhotel living room" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-trece' ); ?>" alt="Image Alternative text" title="The pool" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-cartorce' ); ?>" alt="Image Alternative text" title="hotel 1" />
                                        <img src="<?php echo zoologico_campo( 'img-zoologico-quince' ); ?>" alt="Image Alternative text" title="hotel PORTO BAY RIO INTERNACIONAL de luxe" />
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <h3>Redes Sociales</h3>
                                         <ul class="list list-horizontal list-space" style="text-align:center;">
                                            <li><a class="fa fa-facebook box-icon-normal round animate-icon-bottom-to-top" target="_blank" href="<?php echo zoologico_campo( 'img-zoologico-facebook' ); ?>"></a></li>
                                            <li><a class="fa fa-twitter box-icon-normal round animate-icon-bottom-to-top" target="_blank" href="<?php echo zoologico_campo( 'img-zoologico-twitter' ); ?>"></a></li>
                                            <li><a class="fa fa-youtube box-icon-normal round animate-icon-bottom-to-top" target="_blank" href="<?php echo zoologico_campo( 'img-zoologico-youtube' ); ?>"></a></li>
                                        </ul>
                                    </div>
                                    <div class="gap"></div>
                   ...
                   <div class="col-md-5">
                        ...
                        <div class="booking-item-meta">
                          < <h1 class="lh1em mt40">Excelente!</h1>
    ...
    <script>
        ...
        /*
            ...
            */
            ...
            // Map Markers
            var mapMarkers = [{
                address: "<?php echo zoologico_campo( 'img-zoologico-direccion-dos' ); ?>",
                html: "<strong><?php the_title(); ?></strong><br><?php echo zoologico_campo( 'img-zoologico-direccion' ); ?><br><br><a href='#' onclick='mapCenterAt({latitude: <?php echo zoologico_campo( 'img-zoologico-latitude' ); ?>, longitude: <?php echo zoologico_campo( 'img-zoologico-longitude' ); ?>, zoom: 16}, event)'>[+] zoom here</a>",
                icon: {
            ...
            var initLatitude = <?php echo zoologico_campo( 'img-zoologico-latitude' ); ?>;
            var initLongitude = <?php echo zoologico_campo( 'img-zoologico-longitude' ); ?>;
